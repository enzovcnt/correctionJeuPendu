...
function gameOver(){
    ...
    playAgainButton.classList.add('rejouero')
    ...
    document.querySelector('.rejouero').addEventListener('click', e => {
        console.log('coucou')
        playAgain()
...
function addBodyPart(){
    switch (errors){
        case errors = 0:
            canvasPendu.style.display = "none"
            break;
        case errors = 1:
            head()
            console.log("1")
...
function jambeGauche(){
    dessin.moveTo(70, 80)
    dessin.lineTo(80,100)
    dessin.stroke()
}
function jambeDroite(){
    dessin.moveTo(70, 80)
    dessin.lineTo(60,100)
    dessin.stroke()
}
